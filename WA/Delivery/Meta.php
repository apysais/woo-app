...
class WA_Delivery_Meta {
  ...
  **/
  public function delivery_time( $args = [] ) {
    $prefix = 'wa_delivery_time';
  ...
  * @return  $action, r = get_post_meta(), u = update_post_meta(), d = delete_post_meta
  **/
  public function deliver_on( $args = [] ) {
    $prefix = 'wa_deliver_on';
    if ( isset ( $args['post_id'] ) ) {
  ...
  * @return  $action, r = get_post_meta(), u = update_post_meta(), d = delete_post_meta
  **/
  public function time_deliver( $args = [] ) {
    $prefix = 'wa_time_deliver';
    if ( isset ( $args['post_id'] ) ) {
